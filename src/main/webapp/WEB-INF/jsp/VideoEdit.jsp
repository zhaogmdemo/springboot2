...
<nav class="navbar-inverse">
	...
	<div class="container" style="margin-top: 20px;">
		...
		<form id="infoForm" action="updateVideo.do" class="form-horizontal"  method="post" >
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" value="${Video.time }" id="time" placeholder="精确到秒(正整数)" name="time" rows="3"></input>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<textarea class="form-control" id="title" name="detail" placeholder="" rows="3">${Video.detail}</textarea>
				</div>
			</div>
			<div class="form-group">
