...
<nav class="navbar-inverse">
	...
	<div class="container" style="margin-top: 20px;">
		...
		<form id="infoForm" action="ManagerAddCourse.do" class="form-horizontal"  method="post" >

			
			<div class="form-group">
			    <label for="subjectId" class="col-sm-2 control-label">管理员权限</label>
			    <div class="col-sm-10">
			...
			<div class="form-group">
				<label for="subjectTitle" class="col-sm-2 control-label">账号</label>
				<div class="col-sm-10">
					<input class="form-control" name="accounts" id="accounts" type="text">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<textarea class="form-control" id="adminRemark" name="adminRemark" rows="3"></textarea>
				</div>
			</div>
			<div class="form-group">
		...
		<form id="infoForm1" action="AdminLogin1.do" class="form-horizontal"  method="post" >
		<div class="form-group" >
		<div class="col-sm-offset-2 col-sm-10">
...
<![endif]-->
<script src="${pageContext.request.contextPath}/js/jquery-1.js.下载"></script>
<script src="${pageContext.request.contextPath}/js/bootstrap.js.下载"></script>
<script src="${pageContext.request.contextPath}/js/confirm.js.下载"></script>
<script src="${pageContext.request.contextPath}/js/jquery.js.下载"></script>
<script src="${pageContext.request.contextPath}/js/message_cn.js.下载"></script>
