...
<nav class="navbar-inverse">
	...
	<div class="container" style="margin-top: 20px;">
		...
		<form id="infoForm" action="updateSpeaker.do" class="form-horizontal"  method="post" >
		...
		</form><form id="infoForm1" action="SpeakerShow.do" class="form-horizontal"  method="post" >
		<div class="form-group" >
		<div class="col-sm-offset-2 col-sm-10">
